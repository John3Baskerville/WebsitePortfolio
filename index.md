...
Built a clustering pipeline on my personal Spotify library to automatically group songs into playlists — without any manual labeling. Spotify exposes 13 quantitative **audio features** per track (energy, valence, tempo, etc.); I used these as model inputs and validated cluster quality with feature profiles (heatmaps) and violin plots that describe the generated playlists themes.
